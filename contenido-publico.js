(() => {
  ...
  function patchJefatura() {
    ...
    forms.forEach((form) => form.closest("article")?.classList.add("public-admin-replaced"));

    const notice = document.createElement("article");
    notice.className = "admin-card public-admin-card";
    notice.innerHTML = `<h3>Publicacion global de noticias, paper y educacion</h3><p>Para que una publicacion se vea desde otro navegador, otro computador o fuera del hospital, debe quedar dentro del repositorio de la web. La subida directa desde el navegador queda solo como borrador local y ya no se presenta como publicacion global.</p><div class="public-local-warning">Pasa aqui el titulo, texto, enlace y archivo/link del paper o noticia; yo lo dejo publicado en contenido-web.js para que se vea mundialmente por GitHub Pages.</div><div class="public-actions"><a class="document-button" href="${PUBLISHED_BASE}#/gestion/noticias" target="_blank" rel="noopener noreferrer">Ver noticias publicas</a><a class="document-button" href="${PUBLISHED_BASE}#/gestion/paper" target="_blank" rel="noopener noreferrer">Ver paper del mes</a><a class="document-button" href="${PUBLISHED_BASE}#/gestion/educacion" target="_blank" rel="noopener noreferrer">Ver educacion</a></div>`;
