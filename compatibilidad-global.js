(() => {
  ...
  // Compatibilidad conserva sólo polyfills. El Service Worker está desactivado
  // y Jefatura/Supabase tienen controladores propios; no se cargan parches tardíos.
  window.CRS_REGISTER_SERVICE_WORKER = () => undefined;
})();
