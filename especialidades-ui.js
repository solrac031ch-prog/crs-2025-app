(function () {
  ...
  const cardHints = new Map([
    ...
    ["Hemodinamia", "Activacion y documento 2025"],
    ...
    ["Radiologia intervencional", "Documento de radiologia intervencional"],
  ...
  function ensureFocus(container) {
    ...
    panel.innerHTML = `
      <div>
        ...
        <h3 data-focus-title>Rutas clinicas</h3>
  ...
  function decorateCards(container) {
    container.querySelectorAll("#specialtyGroups .specialty-button").forEach((link) => {
      ...
      const hintText = cardHints.get(title) || meta.text;
  ...
  function updateFocus(container) {
    ...
    setText("[data-hub-active]", meta.label);
    setText("[data-hub-count]", count);
    setText("[data-focus-label]", meta.label);
