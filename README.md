...
La portada incluye un boton `Formularios de turno`. El primer formulario activo es `Antimicrobianos H. Padre Hurtado`. Ley de urgencias incluye material de consulta Decreto 34, buscador orientativo de condiciones clinicas adultas, formularios de activacion/consentimiento pendientes y nota operativa para avisar a jefe de turno y Gestion de Camas. Los formularios de medicamentos de uso ocasional, solicitud de VIH y notificacion obligatoria quedan preparados como pendientes. El flujo `ECO TVP Hospital Sotero del Rio` incluye un boton propio para abrir su cuestionario de Google Forms.
